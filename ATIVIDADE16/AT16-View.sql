...
-- Atividade 2
SELECT salario, datanasci
FROM Funcionarios
WHERE datanasci > 1980 and 1990;

-- Atividade 3

-- Atividade 4
SELECT codigo, segundonome, ultimonome
FROM Funcionarios
WHERE segundonome or ultimonome = "Oliveira";
