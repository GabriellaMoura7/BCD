...
-- 1. Crie uma view chamada "vw_cliente_detalhes" que selecione o nome, email, telefone e a cidade dos clientes.
...
-- 2. Crie uma view chamada "vw_produtos_estoque" que selecione o nome, categoria e quantidade em estoque dos produtos com estoque maior que 100.
...
-- 3. Crie uma view chamada "vw_clientes_nascimento" que selecione o nome, ano de nascimento e mês de nascimento dos clientes.
...
-- 4. Crie uma view chamada "vw_produtos_precos" que selecione o nome do produto e um novo campo "lucro" com a diferença entre o preço de venda e o preço de compra.

ALTER VIEW vw_produtos_precos AS
SELECT 
	nome_produto, 
...
-- 5. Crie uma view chamada "vw_categorias" que exiba as categorias e a contagem de produtos em cada categoria.

CREATE VIEW vw_categorias AS
SELECT categoria, COUNT(*) AS quantdade_produtos
FROM tb_produto 
GROUP BY categoria; 

SELECT * FROM vw_categorias;

-- 6. Usando a view "vw_cliente_detalhes", selecione todos os clientes que moram na cidade de 'São Paulo'.

SELECT nome_cliente, cidade
FROM vw_cliente_detalhes
WHERE cidade = 'São Paulo';

-- 7. Usando a view "vw_produtos_estoque", selecione o nome e a categoria dos produtos que possuem mais de 150 unidades em estoque.
...
-- 8. Usando a view "vw_clientes_nascimento", selecione o nome dos clientes nascidos no mês de fevereiro.

SELECT 
	nome_cliente,
	MONTH(dat_nascimento)
FROM vw_clientes_nascimento
WHERE MONTH(data_nascimento) = MONTH('2');

SELECT * FROM vw_clientes_nascimento;

-- 9. Usando a view "vw_produtos_precos", selecione os produtos com lucro superior a 5.00.
...
-- 10. Usando a view "vw_categorias", selecione as categorias com mais de 10 produtos cadastrados.
